...
class GroupMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_member" do
    assert_difference('GroupMember.count') do
      post group_members_url, params: { group_member: { group_id: @group_member.group_id, group_member_id: @group_member.group_member_id, is_group_admin: @group_member.is_group_admin, member_user_id: @group_member.member_user_id } }
    end
  ...
  test "should update group_member" do
    patch group_member_url(@group_member), params: { group_member: { group_id: @group_member.group_id, group_member_id: @group_member.group_member_id, is_group_admin: @group_member.is_group_admin, member_user_id: @group_member.member_user_id } }
