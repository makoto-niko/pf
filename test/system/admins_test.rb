...
class AdminsTest < ApplicationSystemTestCase
  ...
  test "creating a Admin" do
    ...
    fill_in "Admin created at", with: @admin.admin_created_at
    fill_in "Admin email", with: @admin.admin_email
    fill_in "Admin password", with: @admin.admin_password
    fill_in "Admin updated at", with: @admin.admin_updated_at
    fill_in "Admin username", with: @admin.admin_username
