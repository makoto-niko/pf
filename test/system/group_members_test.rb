...
class GroupMembersTest < ApplicationSystemTestCase
  ...
  test "creating a Group member" do
    ...
    fill_in "Group member", with: @group_member.group_member_id
    check "Is group admin" if @group_member.is_group_admin
    fill_in "Member user", with: @group_member.member_user_id
